@extends('base::layouts.main', ['pagetitle' => 'Catalog / '.$product->getName()])
    ...
    <div class="row">
        <div class="col-md-4" id="image">
            <div class="text-center">
                <img src="{{ $product->getImage() }}" alt="{{ $product->getImage() }}" class="img-thumbnail">
                @if ($product->isAction())
        ...
        <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="product-price-block">
                            @if ($product->isAction())
                                <b>Actie</b>: <span class="price">{{ format_price($product->getPrice(false)) }}</span>
                            @else
                                <b>Bruto</b>: <span class="price">{{ format_price($product->getPrice(false)) }}</span>
                                <br/>
                                <b>Netto</b>: <span class="price">{{ format_price($product->getPrice(true)) }}</span>
                            @endif
                        </div>
            ...
            <div class="panel panel-primary">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td><b>Voorraad</b></td>
                        <td>{{ format_stock_code($product->getStockCode()) }}</td>
                    </tr>
                    <tr>
                        <td><b>Merk</b></td>
